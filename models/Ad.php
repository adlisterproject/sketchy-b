...
class Ad extends BaseModel{
	...
	protected function insert(){
		$insert = "INSERT INTO " . static::$table . " (item_name, price, description, image_path, contact, user_id)
		...
		$stmt->bindValue(':image_path', $this->attributes['image_path'], PDO::PARAM_STR);
